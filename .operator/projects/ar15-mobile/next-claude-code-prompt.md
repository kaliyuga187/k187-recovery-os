# Next Claude Code prompt for: ar15-mobile

Copy-paste this into Claude Code. Replace the placeholders in {{ }} with the real values from your environment.

```
You are working in repo: C:\Users\nk187\Downloads\Projects\ar15-mobile

Goal:
Audit ar15-mobile, decide finish-or-archive, then execute that path.

Context:
ar15-mobile is a mobile-app project at 15/100 completion, 0/100 deploy readiness, 65/100 health. Stack: unknown. 

Current status:
- completion: 15/100
- deploy: 0/100
- health: 65/100
- last edit: 2026-06-24T14:03:53.710Z
- has git: false
- has readme: true
- has tests: false
- has docker: false
...
Files to inspect:
- `C:\Users\nk187\Downloads\Projects\ar15-mobile/README.md` (if exists)
- `C:\Users\nk187\Downloads\Projects\ar15-mobile/package.json` (if exists)
- `C:\Users\nk187\Downloads\Projects\ar15-mobile/Dockerfile` (if exists)
