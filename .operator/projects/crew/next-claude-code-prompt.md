# Next Claude Code prompt for: crew

Copy-paste this into Claude Code. Replace the placeholders in {{ }} with the real values from your environment.

```
You are working in repo: C:\Users\nk187\AppData\Local\Temp\k187-manus-7f928c2c\crew

Goal:
Recover crew from Manus source files, then continue the build.

Context:
crew is a ai-agent project at 15/100 completion, 0/100 deploy readiness, 50/100 health. Stack: unknown. 

Current status:
- completion: 15/100
- deploy: 0/100
- health: 50/100
- last edit: 2026-04-10T21:21:40.000Z
- has git: false
- has readme: true
- has tests: false
- has docker: false
...
Files to inspect:
- `C:\Users\nk187\AppData\Local\Temp\k187-manus-7f928c2c\crew/README.md` (if exists)
- `C:\Users\nk187\AppData\Local\Temp\k187-manus-7f928c2c\crew/package.json` (if exists)
- `C:\Users\nk187\AppData\Local\Temp\k187-manus-7f928c2c\crew/Dockerfile` (if exists)
