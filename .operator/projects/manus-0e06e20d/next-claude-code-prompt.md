# Next Claude Code prompt for: Manus 0e06e20d

Copy-paste this into Claude Code. Replace the placeholders in {{ }} with the real values from your environment.

```
You are working in repo: manus://0e06e20d-67f1-4ad4-af64-e276862774b3

Goal:
Recover Manus 0e06e20d from Manus source files, then continue the build.

Context:
Manus 0e06e20d is a unknown project at 0/100 completion, 0/100 deploy readiness, 20/100 health. Stack: manus. 
...
Files to inspect:
- `manus://0e06e20d-67f1-4ad4-af64-e276862774b3/README.md` (if exists)
- `manus://0e06e20d-67f1-4ad4-af64-e276862774b3/package.json` (if exists)
- `manus://0e06e20d-67f1-4ad4-af64-e276862774b3/Dockerfile` (if exists)
