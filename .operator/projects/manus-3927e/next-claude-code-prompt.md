# Next Claude Code prompt for: Manus 3927e452

Copy-paste this into Claude Code. Replace the placeholders in {{ }} with the real values from your environment.

```
You are working in repo: manus://3927e452-bfb6-45d3-bbd6-22d7ddc813fb

Goal:
Recover Manus 3927e452 from Manus source files, then continue the build.

Context:
Manus 3927e452 is a unknown project at 0/100 completion, 0/100 deploy readiness, 20/100 health. Stack: manus. 
...
Files to inspect:
- `manus://3927e452-bfb6-45d3-bbd6-22d7ddc813fb/README.md` (if exists)
- `manus://3927e452-bfb6-45d3-bbd6-22d7ddc813fb/package.json` (if exists)
- `manus://3927e452-bfb6-45d3-bbd6-22d7ddc813fb/Dockerfile` (if exists)
