# Next Claude Code prompt for: Manus 7e3bc186

Copy-paste this into Claude Code. Replace the placeholders in {{ }} with the real values from your environment.

```
You are working in repo: manus://7e3bc186-0749-4295-a2de-2d3dcd8dd43f

Goal:
Recover Manus 7e3bc186 from Manus source files, then continue the build.

Context:
Manus 7e3bc186 is a unknown project at 0/100 completion, 0/100 deploy readiness, 20/100 health. Stack: manus. 
...
Files to inspect:
- `manus://7e3bc186-0749-4295-a2de-2d3dcd8dd43f/README.md` (if exists)
- `manus://7e3bc186-0749-4295-a2de-2d3dcd8dd43f/package.json` (if exists)
- `manus://7e3bc186-0749-4295-a2de-2d3dcd8dd43f/Dockerfile` (if exists)
