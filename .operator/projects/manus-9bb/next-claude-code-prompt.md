# Next Claude Code prompt for: Manus 9bb34067

Copy-paste this into Claude Code. Replace the placeholders in {{ }} with the real values from your environment.

```
You are working in repo: manus://9bb34067-c2ce-47f0-b4ff-a304b9fe9a17

Goal:
Recover Manus 9bb34067 from Manus source files, then continue the build.

Context:
Manus 9bb34067 is a unknown project at 0/100 completion, 0/100 deploy readiness, 20/100 health. Stack: manus. 
...
Files to inspect:
- `manus://9bb34067-c2ce-47f0-b4ff-a304b9fe9a17/README.md` (if exists)
- `manus://9bb34067-c2ce-47f0-b4ff-a304b9fe9a17/package.json` (if exists)
- `manus://9bb34067-c2ce-47f0-b4ff-a304b9fe9a17/Dockerfile` (if exists)
