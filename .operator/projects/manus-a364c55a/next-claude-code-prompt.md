# Next Claude Code prompt for: Manus a364c55a

Copy-paste this into Claude Code. Replace the placeholders in {{ }} with the real values from your environment.

```
You are working in repo: manus://a364c55a-809b-482d-8573-f2dd1d370ae2

Goal:
Recover Manus a364c55a from Manus source files, then continue the build.

Context:
Manus a364c55a is a unknown project at 0/100 completion, 0/100 deploy readiness, 20/100 health. Stack: manus. 
...
Files to inspect:
- `manus://a364c55a-809b-482d-8573-f2dd1d370ae2/README.md` (if exists)
- `manus://a364c55a-809b-482d-8573-f2dd1d370ae2/package.json` (if exists)
- `manus://a364c55a-809b-482d-8573-f2dd1d370ae2/Dockerfile` (if exists)
