# Next Claude Code prompt for: Manus b1e5d6c3

Copy-paste this into Claude Code. Replace the placeholders in {{ }} with the real values from your environment.

```
You are working in repo: manus://b1e5d6c3-4b11-41fa-be5b-252cad07e1b1

Goal:
Recover Manus b1e5d6c3 from Manus source files, then continue the build.

Context:
Manus b1e5d6c3 is a unknown project at 0/100 completion, 0/100 deploy readiness, 20/100 health. Stack: manus. 
...
Files to inspect:
- `manus://b1e5d6c3-4b11-41fa-be5b-252cad07e1b1/README.md` (if exists)
- `manus://b1e5d6c3-4b11-41fa-be5b-252cad07e1b1/package.json` (if exists)
- `manus://b1e5d6c3-4b11-41fa-be5b-252cad07e1b1/Dockerfile` (if exists)
