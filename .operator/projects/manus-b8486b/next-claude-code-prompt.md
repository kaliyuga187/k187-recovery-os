# Next Claude Code prompt for: Manus b8486b61

Copy-paste this into Claude Code. Replace the placeholders in {{ }} with the real values from your environment.

```
You are working in repo: manus://b8486b61-0a98-43fb-8eac-42de42e64c32

Goal:
Recover Manus b8486b61 from Manus source files, then continue the build.

Context:
Manus b8486b61 is a unknown project at 0/100 completion, 0/100 deploy readiness, 20/100 health. Stack: manus. 
...
Files to inspect:
- `manus://b8486b61-0a98-43fb-8eac-42de42e64c32/README.md` (if exists)
- `manus://b8486b61-0a98-43fb-8eac-42de42e64c32/package.json` (if exists)
- `manus://b8486b61-0a98-43fb-8eac-42de42e64c32/Dockerfile` (if exists)
