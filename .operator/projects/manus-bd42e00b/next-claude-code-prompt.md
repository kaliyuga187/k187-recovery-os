# Next Claude Code prompt for: Manus bd42e00b

Copy-paste this into Claude Code. Replace the placeholders in {{ }} with the real values from your environment.

```
You are working in repo: manus://bd42e00b-dd03-4723-bb5f-1087a29cb78b

Goal:
Recover Manus bd42e00b from Manus source files, then continue the build.

Context:
Manus bd42e00b is a unknown project at 0/100 completion, 0/100 deploy readiness, 20/100 health. Stack: manus. 
...
Files to inspect:
- `manus://bd42e00b-dd03-4723-bb5f-1087a29cb78b/README.md` (if exists)
- `manus://bd42e00b-dd03-4723-bb5f-1087a29cb78b/package.json` (if exists)
- `manus://bd42e00b-dd03-4723-bb5f-1087a29cb78b/Dockerfile` (if exists)
