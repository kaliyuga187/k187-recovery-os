# Next Claude Code prompt for: Manus d7387ff0

Copy-paste this into Claude Code. Replace the placeholders in {{ }} with the real values from your environment.

```
You are working in repo: manus://d7387ff0-a551-48c2-b978-5b8c1799ce21

Goal:
Recover Manus d7387ff0 from Manus source files, then continue the build.

Context:
Manus d7387ff0 is a unknown project at 0/100 completion, 0/100 deploy readiness, 20/100 health. Stack: manus. 
...
Files to inspect:
- `manus://d7387ff0-a551-48c2-b978-5b8c1799ce21/README.md` (if exists)
- `manus://d7387ff0-a551-48c2-b978-5b8c1799ce21/package.json` (if exists)
- `manus://d7387ff0-a551-48c2-b978-5b8c1799ce21/Dockerfile` (if exists)
