# Next Claude Code prompt for: Manus 80089189

Copy-paste this into Claude Code. Replace the placeholders in {{ }} with the real values from your environment.

```
You are working in repo: manus://80089189-a8cc-4b98-8183-1deba258c116

Goal:
Recover Manus 80089189 from Manus source files, then continue the build.

Context:
Manus 80089189 is a unknown project at 0/100 completion, 0/100 deploy readiness, 20/100 health. Stack: manus. 
...
Files to inspect:
- `manus://80089189-a8cc-4b98-8183-1deba258c116/README.md` (if exists)
- `manus://80089189-a8cc-4b98-8183-1deba258c116/package.json` (if exists)
- `manus://80089189-a8cc-4b98-8183-1deba258c116/Dockerfile` (if exists)
