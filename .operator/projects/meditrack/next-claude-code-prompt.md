# Next Claude Code prompt for: meditrack

Copy-paste this into Claude Code. Replace the placeholders in {{ }} with the real values from your environment.

```
You are working in repo: manus://019d7f56-69c3-70e4-bf1b-17a4a0d2db15

Goal:
Recover meditrack from Manus source files, then continue the build.

Context:
meditrack is a unknown project at 0/100 completion, 0/100 deploy readiness, 20/100 health. Stack: manus. 

Current status:
- completion: 0/100
- deploy: 0/100
- health: 20/100
- last edit: 2026-05-05T00:22:07.377Z
- has git: false
- has readme: false
- has tests: false
- has docker: false
...
Files to inspect:
- `manus://019d7f56-69c3-70e4-bf1b-17a4a0d2db15/README.md` (if exists)
- `manus://019d7f56-69c3-70e4-bf1b-17a4a0d2db15/package.json` (if exists)
- `manus://019d7f56-69c3-70e4-bf1b-17a4a0d2db15/Dockerfile` (if exists)
