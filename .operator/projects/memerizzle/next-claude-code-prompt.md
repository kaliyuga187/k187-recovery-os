# Next Claude Code prompt for: memerizzle
...
Goal:
Audit memerizzle, decide finish-or-archive, then execute that path.

Context:
memerizzle is a trading-bot project at 15/100 completion, 0/100 deploy readiness, 65/100 health. Stack: unknown. 

Current status:
- completion: 15/100
- deploy: 0/100
- health: 65/100
- last edit: 2026-05-19T18:18:18.086Z
- has git: false
- has readme: true
- has tests: false
- has docker: false
...
Files to inspect:
- `C:\Users\nk187\Downloads\Projects\memerizzle/README.md` (if exists)
- `C:\Users\nk187\Downloads\Projects\memerizzle/package.json` (if exists)
- `C:\Users\nk187\Downloads\Projects\memerizzle/Dockerfile` (if exists)
