# Next Claude Code prompt for: @next/rspack-core

Copy-paste this into Claude Code. Replace the placeholders in {{ }} with the real values from your environment.

```
You are working in repo: manus://c996b19c-8232-4d11-a79e-8a8fff41f75d

Goal:
Recover @next/rspack-core from Manus source files, then continue the build.

Context:
@next/rspack-core is a unknown project at 0/100 completion, 0/100 deploy readiness, 20/100 health. Stack: manus. 
...
Files to inspect:
- `manus://c996b19c-8232-4d11-a79e-8a8fff41f75d/README.md` (if exists)
- `manus://c996b19c-8232-4d11-a79e-8a8fff41f75d/package.json` (if exists)
- `manus://c996b19c-8232-4d11-a79e-8a8fff41f75d/Dockerfile` (if exists)
