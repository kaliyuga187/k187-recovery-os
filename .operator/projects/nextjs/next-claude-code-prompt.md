# Next Claude Code prompt for: nextjs

Copy-paste this into Claude Code. Replace the placeholders in {{ }} with the real values from your environment.

```
You are working in repo: manus://c0c6e11b-d13c-4aea-9d1b-f18955344d8c

Goal:
Recover nextjs from Manus source files, then continue the build.

Context:
nextjs is a unknown project at 0/100 completion, 0/100 deploy readiness, 20/100 health. Stack: manus. 
...
Files to inspect:
- `manus://c0c6e11b-d13c-4aea-9d1b-f18955344d8c/README.md` (if exists)
- `manus://c0c6e11b-d13c-4aea-9d1b-f18955344d8c/package.json` (if exists)
- `manus://c0c6e11b-d13c-4aea-9d1b-f18955344d8c/Dockerfile` (if exists)
