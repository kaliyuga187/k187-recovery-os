# Next Claude Code prompt for: Primo

Copy-paste this into Claude Code. Replace the placeholders in {{ }} with the real values from your environment.

```
You are working in repo: manus://019ded79-c7a7-77ec-9232-811bf5b8ebe6

Goal:
Recover Primo from Manus source files, then continue the build.

Context:
Primo is a unknown project at 0/100 completion, 0/100 deploy readiness, 20/100 health. Stack: manus. 

Current status:
- completion: 0/100
- deploy: 0/100
- health: 20/100
- last edit: 2026-05-05T00:20:10.859Z
- has git: false
- has readme: false
- has tests: false
- has docker: false
...
Files to inspect:
- `manus://019ded79-c7a7-77ec-9232-811bf5b8ebe6/README.md` (if exists)
- `manus://019ded79-c7a7-77ec-9232-811bf5b8ebe6/package.json` (if exists)
- `manus://019ded79-c7a7-77ec-9232-811bf5b8ebe6/Dockerfile` (if exists)
