# Next Claude Code prompt for: react_repo

Copy-paste this into Claude Code. Replace the placeholders in {{ }} with the real values from your environment.

```
You are working in repo: C:\Users\nk187\Downloads\Projects\concrete-estimator

Goal:
Audit react_repo, decide finish-or-archive, then execute that path.

Context:
react_repo is a web-app project at 25/100 completion, 10/100 deploy readiness, 70/100 health. Stack: node, pnpm, postcss, tailwind, typescript, vite. 

Current status:
- completion: 25/100
- deploy: 10/100
- health: 70/100
- last edit: 2026-06-24T14:03:53.839Z
- has git: false
- has readme: true
- has tests: false
- has docker: false
...
Files to inspect:
- `C:\Users\nk187\Downloads\Projects\concrete-estimator/README.md` (if exists)
- `C:\Users\nk187\Downloads\Projects\concrete-estimator/package.json` (if exists)
- `C:\Users\nk187\Downloads\Projects\concrete-estimator/Dockerfile` (if exists)
